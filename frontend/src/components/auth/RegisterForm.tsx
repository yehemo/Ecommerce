...
export default function RegisterForm() {
    ...
    return (
        <form onSubmit={submitForm} className="space-y-6">
            ...
            <div>
                <label htmlFor="passwordConfirmation" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-100">
                    Confirm Password
                </label>
                <div className="mt-2">
                    <input
            ...
            <p className="mt-10 text-center text-sm text-zinc-500 dark:text-zinc-400">
                ...
                <Link href="/store/login" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">
                    Sign in
                </Link>
            </p>
        </form>
