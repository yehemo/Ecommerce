...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/lyhour/Ecommerce/backend/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/lyhour/Ecommerce/backend/public/storage','logging.default','logging.deprecations.channel',
...
'sanctum.csrf-cookie','categories.index','categories.store','categories.show',
'categories.update','categories.destroy','products.index','products.store','products.show',
'products.update','products.destroy','register',
...
'SANCTUM_STATEFUL_DOMAINS','FRONTEND_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
