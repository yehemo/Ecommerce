...
class ProductVariantOptionValuePolicy
{
     ...
     */
    public function restore(User $user, ProductVariantOptionValue $productVariantOptionValue): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, ProductVariantOptionValue $productVariantOptionValue): bool
    {
        return false;
    }
}
